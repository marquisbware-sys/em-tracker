...
def calculate_em_for_ticker(ticker_sym, previous=None):
    ...
    try:
        ...
        def get_straddle_price(expiry):
                ...
                # Estimate IV from the call (midpoint implied vol)
                iv = None
                try:
        ...
        if weekly_straddle:
            ...
            # Carry forward previous weekly EM values
            ...
            # Carry forward previous monthly EM values
...
def _build_result_with_carried_values(ticker_sym, price, previous, weekly_exp=None, monthly_exp=None):
    ...
    if previous:
                    # Carry forward expiry dates if not already set
